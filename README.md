...
- [Portable Runtime Build Agent Prompt](docs/prompts/portable-runtime-build-agent.md)
- [Selected Portability Build Agent Prompt](docs/prompts/selected-portability-build-agent.md)
...
- `ship app export create --confirm <token>` for confirmed metadata/runtime export bundles with redacted env shape, a `.tar` archive, and receipts.
- `ship app restore-drill plan`, `ship app cutover plan`, and `ship app isolation plan` for planning-only future movement workflows.
