...
15. Next work: collect one real app runtime snapshot, then run opt-in HTTP/Docker/provider probes behind explicit read-only flags before any production migration rehearsal.
