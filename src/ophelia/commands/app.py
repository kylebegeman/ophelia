...
def register(subparsers: _SubParsersAction) -> None:
    ...
    traffic_plan_parser.add_argument("--dns-provider", choices=["manual"], default="manual")
    traffic_plan_parser.add_argument("--caddy-provider", choices=["manual"], default="manual")
    ...
    traffic_apply_parser.add_argument("--dns-provider", choices=["manual"], default="manual")
    traffic_apply_parser.add_argument("--caddy-provider", choices=["manual"], default="manual")
