        ...
        changes.append(
            {
                ...
                "caddy": {
                    ...
                    "mutation_supported": False,
                    "planned_action": "stage target route through the selected provider; live reloads require a future provider backend",
                },
                "rollback": {
                    "source_owner": source_host,
    ...
    checks.append(
        {
            ...
            "executed": run_target_health and not bool(url_issue),
            "url": target_health_url,
        }
    )
    return {
...
def _plan_file_caddy_provider(
    ...
    timeout = _positive_int(section.get("timeout"), default=30)
    ...
    try:
        ...
        for raw_change in traffic_changes:
            ...
            next_value = {
                ...
                "app": raw_change.get("target_owner"),
