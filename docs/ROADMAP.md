...
The proposed next product direction, target host-agent architecture, verified
...
This roadmap remains the active delivery record until that proposal is accepted
and converted into tracked work.
