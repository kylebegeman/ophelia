...
redacted runtime files, checksums, and receipts only. Live database dumps, volume
archives, and import apply remain future work and must use confirmation tokens
from matching plans.
