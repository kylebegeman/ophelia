...
Use `profile: console` when the manifest is primarily hosting a Console runtime or a Console-backed operator surface.
...
This is the primary way to ship Console-hosted Console bundles or other static operator assets alongside an app image without baking them into the container first.
...
## Example: Console-backed console surface
