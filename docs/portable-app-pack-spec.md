...
Status: draft, with Phase 1 manifest support, pack validation/explain, export
plan, and import plan implemented.
...
isolated target service without damaging the live app.
