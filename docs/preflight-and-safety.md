...
- traffic apply records provider intent and checkpoint receipts but does not
  mutate DNS or Caddy providers
...
- rollback is file-level; traffic rollback notes are checkpointed but provider
