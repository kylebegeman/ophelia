...
class LiveHydrationTests(unittest.TestCase):
    ...
    def test_fixture_incomplete_hydration_is_blocked_and_actionable(self) -> None:
        ...
        self.assertEqual(1, report["sections"]["env"]["required_count"])
        self.assertEqual(1, len(report["sections"]["env"]["missing_required"]))
        self.assertEqual(1, len(report["sections"]["secrets"]["missing_required"]))
